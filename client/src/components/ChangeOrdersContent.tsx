...
/**
 * Reusable Change Orders content component - can be used standalone or in tabs
 */
export default function ChangeOrdersContent() {
    const { user } = useAuth();
    ...
    const canManage = useMemo(() => user && ["admin", "department_manager", "project_manager"].includes(user.role), [user]);
